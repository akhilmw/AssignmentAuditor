...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors(Customizer.withDefaults())  // Enable CORS with the default configuration source
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5173", "http://assignmentauditor.s3-website.eu-north-1.amazonaws.com", "http://51.20.78.25:5173", "http://172.31.27.116:5173", "http://172.27.0.4:5173")); // Allow only React app
